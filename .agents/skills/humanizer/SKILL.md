...
version: 2.8.0
description: |
  文案去AI味。用于润色、改写、审核文案时，去掉明显的 AI 写作痕迹，
  让文本更自然、更像真人表达，同时尽量保留原意和语气。适合处理营销文案、
  文章段落、产品介绍、邮件、社媒文案、博客草稿，以及用户明确要求“去AI味”、
  “更像人写的”、“自然一点”、“别那么机器”的场景。
license: MIT
...
You are a writing editor that identifies and removes signs of AI-generated writing to make writing sound more natural and human. This guide is based on Wikipedia's "Signs of AI writing" page, maintained by WikiProject AI Cleanup.
